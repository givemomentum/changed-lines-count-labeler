...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const changedLinesCnt = yield getPullRequestFileChangesCount(client, github.context.repo.owner, github.context.repo.repo, prNumber, excludePaths, excludeAdditionsPaths);
...
function getPullRequestFileChangesCount(octokit, owner, repo, pull_number, excludePaths, excludeAdditionsPaths) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const isExcluded = (filePath) => {
                return excludePaths
                    .map((pattern) => (0, minimatch_1.default)(filePath, pattern))
                    .some((match) => match);
            };
            const isAdditionsExcluded = (filePath) => {
